...
!---CLAIM FOR PMTLD
      ...
      REAL*8 KE2,PE2,TE2,WORK2,DTDT2,DVDT2,DEDT2,DWDT2,PE_I2,WG1_TLD,WG2_TLD,JP1,JP2
...
!      CALL get_walltime(T_START)
      ...
      OPEN(UNIT=8,FILE='P.DAT')             ! dynamic pressure of the jets on wetted walls
...
WRITE(8,"(3(E15.8,1X))") TIME,JP1,JP2
!****************************** OUTPUT ******************************
...
SUBROUTINE PMTLD_BEM(NNODE,NELM,NGA,ICON,NELEM,ME,NS,LN,BUNTYP,MU1,MU2,POR,&
                ...
                &NODE,PHI,NODE_TEMP,FOR,KE,PE,TE,WORK,PE0,DTDT,DVDT,DEDT,DWDT,WG1_TLD,WG2_TLD,JP1,JP2)
IMPLICIT NONE
...
REAL*8 WG1_TLD,WG2_TLD,JP1,JP2
...
CALL PRESSURE_TLD(ICON,DEP,THO,GRAV,NNODE,NS,NODE,PHIT,DP,PR,P_ATM,JP1,JP2)
...
!		END IF
    ...
    END
!********************************************************************
SUBROUTINE PRESSURE_TLD(ICON,DEP,THO,GRAV,NNODE,NS,NODE,PHIT,DP,PR,P_ATM,JP1,JP2)
!********************************************************************
      IMPLICIT NONE
...
!----CALCULATE THE DYNAMIC PRESSURE OF THE JET ON WALL, THE JET IS DEFINED AS THE TOP 3 NODES NEAR THE FS
    JP2=0.D0
    DO I=NS(1)+1,NS(1)+3
	JP2=JP2+THO*(PHIT(I)+0.5D0*(DP(I,1)**2+DP(I,2)**2))
    END DO
    JP2=JP2/3.D0
    
    JP1=0.D0
    DO I=NNODE,NNODE-2,-1
	JP1=JP1+THO*(PHIT(I)+0.5D0*(DP(I,1)**2+DP(I,2)**2))
    END DO
    JP1=JP1/3.D0
